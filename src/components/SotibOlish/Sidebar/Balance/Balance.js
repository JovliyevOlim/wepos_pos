...
function Balance({sidebaractive2, changeLink, link, users}) {
    ...
    useEffect(() => {
        if (link !== 'balance') {
            ...
            setfill('')
            setfontsize('')
            let style = document.getElementById('balance')
    ...
    return (
        <div className={'row list active'} id={'balance'}>
            <div className="imgDiv" onClick={toggle}>
                <div className={'d-flex align-items-center'}>
                    <svg className={`sidebar-img2 ${fill}`} width="24" height="24" version="1.1" id="Layer_1"
...
export default connect((users), {})(Balance)
