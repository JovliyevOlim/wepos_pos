            ...
            <div className={'row  mt-4'}>
                ...
                <div className="col-12  mt-4">
                    <form onSubmit={handleSubmit(saqla)}>
                        <div className="row">
                            <div className="col-md-12 d-flex flex-wrap align-items-start">
                                <div style={{minHeight: "100px"}} className="col-md-4 col-sm-12 ">
                                ...
                                <div style={{minHeight: "100px"}} className="col-md-4 col-sm-12 ">
                                    <label htmlFor={'paymentMethodId'}>To'lov turi</label>
                                ...
                                <div style={{minHeight: "100px"}} className="col-md-4 col-sm-12 "><label
                                ...
                                <div style={{minHeight: "100px"}} className="col-md-4 col-sm-12">
                                    <label htmlFor={'sum'}>{t('Expenses.6')}</label>
                            ...
                            <div className="col-md-12 mt-3 d-flex justify-content-end">
                                <button className={'btn btn-success'} type={'submit'}>{t('Buttons.2')}</button>
                            </div>
                        </div>
                    </form>
                </div>
