								...
								<div className="card-header border-0">
									<div className="d-flex">
										...
										<div className="invoices">
											<h4 class="mb-2 fs-20 font-w700">14.100.000</h4>
											<span>Jami haridlar</span>
										</div>
									</div>
								</div>
							...
							<div className="card overflow-hidden">
								<div className="card-header border-0">
									<div className="d-flex">
										...
										<div className="invoices">
											<h4 class="mb-2 fs-20 font-w700">17.000.000 so'm</h4>
							...
							<div className="card overflow-hidden">
								<div className="card-header border-0">
									<div className="d-flex">
										...
										<div className="invoices">
											<h4 class="mb-2 fs-20 font-w700">2.250.000</h4>
											<span>Nasiyalar</span>
										</div>
									</div>
								</div>
							...
							<div className="card overflow-hidden">
								<div className="card-header border-0">
									<div className="d-flex">
										...
										<div className="invoices">
											<h4 class="mb-2 fs-20 font-w700">652</h4>
											<span>Dillerlarda qarzim</span>
										</div>
									</div>
								</div>
								<div className="card-body p-0">
							...
							<div className="card">
								<div className="card-body">
									<div className="row">
										...
										<h4 className="fs-20 text-black mb-4 font-w700">To'lovlar</h4>
											<div className="row">
											<div className="d-flex col-xl-12 col-xxl-6  col-md-12 col-6 mb-4">
													...
													<div>
														<p className="fs-14 mb-2">Plastik</p>
														<span className="fs-16 font-w600 text-light"><span className="text-black me-2 font-w700">5.100.000</span>/17.000.000 so'm</span>
													</div>
												</div>
												<div className="d-flex col-xl-12 col-xxl-6 col-md-12 col-6 mb-4">
													<svg className="me-3" width="14" height="54" viewBox="0 0 14 54" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<div>
														<p className="fs-14 mb-2">Naqd</p>
														<span className="fs-16 font-w600 text-light"><span className="text-black me-2 font-w700">9.350.000</span>/17.000.000 so'm</span>
													</div>
												</div>
												<div className="d-flex col-xl-12 col-xxl-6 col-md-12 col-6 mb-4">
													<svg className="me-3" width="14" height="54" viewBox="0 0 14 54" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<div>
														<p className="fs-14 mb-2">Bank orqali</p>
														<span className="fs-16 font-w600 text-light"><span className="text-black me-2 font-w700">0</span>/17.000.000 so'm</span>
													</div>
												</div>
												<div className="d-flex col-xl-12 col-xxl-6 col-md-12 col-6 mb-4">
													<svg className="me-3" width="14" height="54" viewBox="0 0 14 54" fill="none" xmlns="http://www.w3.org/2000/svg">	
													...
													<div>
														<p className="fs-14 mb-2">Qarz</p>
														<span className="fs-16 font-w600 text-light"><span className="text-black me-2 font-w700">2.550.000</span>/17.000.000 so'm</span>
													</div>
												</div>
											</div>
										</div>
										<div className="col-xl-7  col-xxl-12 col-md-7">
											...
											<div className="col-sm-6 mb-4">
													<div className="bg-gradient1 rounded text-center p-3">
														...
														<span className="fs-14 text-white d-block">Plastik</span>
													</div>
												</div>
												<div className="col-sm-6 mb-4">
													<div className="bg-gradient2 rounded text-center p-3">
														<div className="d-inline-block position-relative donut-chart-sale mb-3">
															<DonutChart value="40" backgroundColor="rgba(255, 255, 255,1)"
																backgroundColor2= "rgba(255, 255, 255, 0.2)"
															/>
															<small className="text-white">55%</small>
														</div>
														<span className="fs-14 text-white d-block">Naqd</span>
													</div>
												</div>
												<div className="col-sm-6 mb-sm-0 mb-4">
													<div className="rounded text-center p-3 bg-gradient3">
														...
														<span className="fs-14 text-white d-block">Bank orqali</span>
													</div>
												</div>
												<div className="col-sm-6 mb-sm-0 mb-4">
													<div className="rounded text-center p-3 bg-gradient4">
														...
														<span className="fs-14 text-white d-block">Qarz</span>
													</div>
												</div>
											</div>
										</div>
						...
						<div className="col-xl-12">
							<div className="card overflow-hidden">
								<div className="card-header d-sm-flex d-block border-0 pb-0">
									...
									<p className="fs-14 mb-1 font-w700">Umumiy foyda hajmi</p>
										<span className="mb-0">
										<svg width="12" height="6" viewBox="0 0 12 6" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M11.9999 6L5.99994 -2.62268e-07L-6.10352e-05 6" fill="#2BC155"/>
										</svg>
										<strong className="fs-32 text-black ms-2 me-3 font-w800">23%</strong>Bugungi foyda</span>
									</div>
							...
							<div className="row">
								...
								<div className="card">
										<div className="card-header border-0 pb-0">
											<div>
												<h4 className="mb-2 font-w700">Mijozlar va nasiyalar</h4>
												<span className="fs-12">Buyerda barcha yangi mijozlaringizni kuzatib borasiz</span>
											</div>
											<Dropdown className="dropdown">
												<Dropdown.Toggle as="div" className="btn-link i-false">
										...
										<div className="card-body">	
											<div className="user-bx">
												<img src={small} alt="" />
												<div>
													<h6 className="user-name">Abdulloh</h6>
													<span className="meta">Tel: +99894847478</span>
												</div>
												<i className="las la-check-circle check-icon"></i>
											</div>
											<h4 className="mt-3 mb-3">Barcha mijozlar<Link to={"#"} className="fs-16 float-end text-secondary font-w600">Ro'yxat... </Link></h4>
											...
											<h4 className="mt-3 mb-0">Bugungi nasiyalar</h4>
											...
											<div className="text-secondary fs-16 d-flex justify-content-between font-w600 mt-4">
												<span>Barcha nasiyalar</span>
												<span>45.021.000 so'm</span>
											</div>
										</div>
										<div className="card-footer border-0 pt-0">
											<Link to={"#"} className="btn btn-primary d-block btn-lg text-uppercase">Qarzni uzish</Link>
										</div>
									</div>
								</div>
								<div className="col-xl-6 col-xxl-12 col-sm-6">
								<div className="card">
										<div className="card-header border-0 pb-0">
											<div>
												<h4 className="mb-2 fs-20 font-w700">Harajatlar</h4>
												<span className="fs-12">Buyerda turlariga qarab xarajatlar ko'rinadi</span>
											</div>
										...
										<div className="card-body">	
											<div className="progress default-progress">
												<div className="progress-bar bg-gradient1 progress-animated" style={{width: "62%", height:"20px"}}>
													<span className="sr-only">45% Complete</span>
												</div>
											</div>
											<div className="d-flex align-items-end mt-2 pb-3 justify-content-between">
												<span>Ishchi haqi (oylik)</span>
												<span className="fs-16 font-w600 text-light"><span className="text-black pe-2">35.000.000</span>/85.mln</span>
											</div>
											<div className="progress default-progress mt-4">
												<div className="progress-bar bg-gradient2 progress-animated" style={{width: "27%", height:"20px"}} >
													<span className="sr-only">70% Complete</span>
												</div>
											</div>
											<div className="d-flex align-items-end mt-2 pb-3 justify-content-between">
												<span>Texnikalarga</span>
												<span className="fs-16 font-w600 text-light"><span className="text-black pe-2">20.000.000</span>/85.mln</span>
											</div>
											<div className="progress default-progress mt-4">
												<div className="progress-bar bg-gradient4 progress-animated" style={{width: "20%", height:"20px"}} >
													<span className="sr-only">35% Complete</span>
												</div>
											</div>
											<div className="d-flex align-items-end mt-2 pb-3 justify-content-between">
												<span>Marketinga</span>
												<span className="fs-16 font-w600 text-light"><span className="text-black pe-2">17.000.000.</span>85.mln</span>
											</div>
											<div className="progress default-progress mt-4">
												<div className="progress-bar bg-gradient3 progress-animated" style={{width: "15%", height:"20px"}}>
											...
											<div className="d-flex align-items-end mt-2 justify-content-between">
												...
												<span className="fs-16 font-w600 text-light"><span className="text-black pe-2">13.000.000</span>/85.mln</span>
											</div>
										</div>
										<div className="card-footer border-0 pt-0">
											<Link to={"#"} className="btn btn-outline-primary d-block btn-lg">Xarajat qo'shish</Link>
										</div>
									</div>
								</div>
